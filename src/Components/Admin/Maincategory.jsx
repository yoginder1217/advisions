      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-9 col-12 py-4">
            <h5 className="bg-primary text-center p-2">Maincategory <Link to="/admin-add-maincategory" className='text-dark'><span className='fa fa-plus float-end'></span></Link></h5>
